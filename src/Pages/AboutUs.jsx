...
const Section = ({ icon, title, children }) => (
  <Card className="flex gap-5">
    <div
      className="shrink-0 w-11 h-11 rounded-2xl bg-brand-50 border border-brand-100
  ...
  <Page className="max-w-2xl">
    ...
    <div className="space-y-4">
      ...
      <Section icon={<UsersIcon size={18} />} title="Our Team">
        Our team of experienced professionals is dedicated to delivering exceptional value. Every
        member — from engineers to support — plays a crucial role in our success.
      </Section>
      ...
      <Section icon={<MailIcon size={18} />} title="Get in Touch">
        <p>
          ...
          . We value your input and are continuously improving the platform based on user
          suggestions.
        </p>
      </Section>
    </div>
